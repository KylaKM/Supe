...
public class Tab44Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        try {
            InputStream in = getActivity().getAssets().open("beverages.json");
            readJsonStream(in);
        }
        catch(IOException e) {
            e.printStackTrace();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab4_4fragment, container, false);
        txt3 = (TextView)view.findViewById(R.id.text4Tab4);
        txt3.setText(week);
