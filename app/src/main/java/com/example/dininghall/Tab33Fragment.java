...
public class Tab33Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab3_3fragment, container, false);
        txt3 = (TextView)view.findViewById(R.id.text3Tab3);
        txt3.setText(week);
